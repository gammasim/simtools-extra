...
r"""
    ...
    generated by sim_telarray (no later models are part of the sim_telarray distribution).
    ...
    (with the addition of two missing prod5 files provided as part of this repository).
